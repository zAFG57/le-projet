<?php 
    ...
    if(isset($_GET['proID']) && ControllerChatUsers::openChat($_SESSION['userID'], intval($_GET['proID']))){
        header("Location: ./chat.php?chatID=". ControllerChatUsers::openChat($_SESSION['userID'], intval($_GET['proID'])));
        exit;
    }
...
<?php
    if(isset($_GET['chatID']) && ControllerChatUsers::getChatIDExisting(intval($_GET['chatID']))) {
