<?php 
    ...
    class Csrf extends Config{
        public static function createToken() {
            ...
            $t = time();
            $hash = parent::urlSafeEncode(hash_hmac('sha256', session_id() . $seed . $t, Database::CSRF_TOKEN_SECRET, true));
        ...
        public static function validateToken($token) {
            ...
            if(count($parts) === 3) {
                $hash = hash_hmac('sha256', session_id() . $parts[1] . $parts[2], Database::CSRF_TOKEN_SECRET, true);
